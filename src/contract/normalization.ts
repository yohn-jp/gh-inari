...
export const MAX_NORMALIZABLE_STRING_LENGTH = 65_536 as const;
...
export type FieldNormalizationResult =
  ...
  | { readonly ok: false; readonly violation: FieldNormalizationViolation };
...
export function normalizeFieldValue(field: CanonicalField, value: unknown): FieldNormalizationResult {
 ...
 */
function normalizeStringValue(value: string): FieldNormalizationResult {
...
function normalizeStringArrayValue(value: readonly unknown[]): FieldNormalizationResult {
