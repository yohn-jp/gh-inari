...
import { createLocalSessionBinding, validateLocalSessionBinding, type LocalSessionBinding } from "./session-binding.js";
import {
...
function localRuntimeSigningMaterial(environment: NodeJS.ProcessEnv): LocalRuntimeSigningMaterial {
  ...
  const authority = trustedRuntimeAuthority(environment);
