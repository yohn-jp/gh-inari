import { CHANGE_CONTRACT_VERSION, MAX_CHANGE_DIAGNOSTIC_MESSAGE_LENGTH, MAX_CHANGE_DIAGNOSTIC_PATH_LENGTH, MAX_CHANGE_DIAGNOSTICS, createChangeDiagnosticReport, } from "./change.js";
/** The trusted Actions failure envelope stays small even when Core is valid. */
export const MAX_TRUSTED_FAILURE_DIAGNOSTICS_BYTES = 16_384;
...
export function isSecretSafeBoundedText(value, maximum) {
 ...
 */
export function normalizeTrustedFailureDiagnostics(value) {
    if (value === undefined)
        return undefined;
    ...
    for (const candidate of value) {
        ...
        if (candidate.version !== CHANGE_CONTRACT_VERSION ||
    ...
    const diagnostics = createChangeDiagnosticReport(value).diagnostics;
...
export function isSafeTrustedFailureDiagnostics(value) {
    try {
...
//# sourceMappingURL=change-failure-diagnostics.js.map